...
q-page
  ...
  section#new.q-pa-md-xl.bg-secondary
    ...
    .column
      router-link.row.newInfo(v-for="newInfo in news" :key="newInfo._id" :to="'/news/' + newInfo._id" data-aos="flip-up")
  ...
  section#section2.colmn.q-pa-xl.q-mx-auto.justify-center
    ...
    .row.flex-center
      .col-xs-12.col-sm-6.col-md-3.q-mx-lg.q-my-md(v-for="product in products" :key="product.id" data-aos="zoom-in-up")
  ...
  section#Event.column.q-pa-xl.bg-pink
    ...
    swiper(v-bind="swiperOptions")
      swiper-slide(v-for="event in events" )
        .event.cursor-pointer(@click="router.push('/event/' + event._id)" data-aos="flip-left")
